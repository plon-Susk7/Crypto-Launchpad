...
export function TokenLaunchpad() {
    ...
    async function createToken() {
        ...
        const transaction3 = new Transaction().add(
            createMintToInstruction(mintKeypair.publicKey, associatedToken, wallet.publicKey, supply.value*1000000000, [], TOKEN_2022_PROGRAM_ID)
        );
    ...
    return  <div style={{
        ...
        <input id="supply" className='inputText' type='number' placeholder='Initial Supply'></input> <br />
